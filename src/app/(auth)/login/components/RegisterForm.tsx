...
export default function RegisterForm({ onSwitchTab }: { onSwitchTab: () => void }) {
  ...
  const inputClass =
  "w-full px-4 py-3 lg:py-3.5 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-400/20 focus:border-amber-400 transition-all duration-300 text-sm disabled:opacity-60 [&:-webkit-autofill]:bg-slate-50 [&:-webkit-autofill]:shadow-[inset_0_0_0px_1000px_rgb(248,250,252)]";
